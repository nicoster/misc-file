        ...
        if (cropValue != null) {
            ...
            if (contentUri.startsWith("http://")) {
                ...
                final ProgressDialog dialog = ProgressDialog.show(context,
                        context.getResources().getString(Res.string.initializing),
...
//                                    }
            ...
            if (outputUri != null) {
                ...
                try {
                    ...
                    ((Activity) context).setResult(Activity.RESULT_OK,
                            new Intent(outputUri.toString()).putExtras(extras));
                    resultSet = true;
                } catch (Exception ex) {
                    Log.e(Gallery.TAG, TAG + ": " + "Cannot save to uri " + outputUri.toString());
                } finally {
    ...
    public void onCreate(Bundle icicle) {
            ...
            try {
                if (mItem != null) {
                    ...
                    if (targetScheme.equals("file")) {
                        ...
                        rotation = (int) Shared.exifOrientationToDegrees(exif.getAttributeInt(
        ...
        if (mBitmap == null) {
            Log.e(Gallery.TAG, TAG + ": " + "Cannot load bitmap, exiting.");
            finish();
            return;
        }
    ...
    private void startFaceDetection() {
        ...
        Util.startBackgroundJob(this, null, getResources().getString(Res.string.running_face_detection),
                new Runnable() {
                    public void run() {
    ...
    private void saveOutput(Bitmap croppedImage) {
        if (mSaveUri != null) {
            ...
            try {
                ...
                Log.e(Gallery.TAG, TAG + ": " + "Cannot open file: " + mSaveUri, ex);
            } finally {
                Util.closeSilently(outputStream);
            }
            Bundle extras = new Bundle();
            ...
            if (mItem == null) {
                ...
                Uri newUri = ImageManager.addImage(mContentResolver, title, item.mDateAddedInSec, item.mDateTakenInMs,
                        latitude, longitude, directory.toString(), finalFileName, croppedImage, null, degree);
                if (newUri != null) {
