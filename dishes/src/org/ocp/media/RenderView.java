...
public final class RenderView extends GLSurfaceView implements GLSurfaceView.Renderer, SensorEventListener {
    ...
    private void loadTextureAsync(Texture texture) {
        try {
            ...
            Log.i(Gallery.TAG, TAG + ": " + "Bitmap power of 2 creation fail, outofmemory");
            handleLowMemory();
        }
    }
    ...
    private void uploadTexture(Texture texture, int[] textureId) {
        ...
        if (bitmap != null) {
            ...
            if (glError != GL11.GL_NO_ERROR) {
                ...
                // later time
                Log.i(Gallery.TAG, TAG + ": " + "Texture creation fail, glError " + glError);
                texture.mId = 0;
                texture.mBitmap = null;
                ...
                final TextureReference textureRef = new TextureReference(texture, gl, mUnreferencedTextureQueue,
                        textureId[0]);
    ...
    public void onPause() {
        super.onPause();
        Log.i(Gallery.TAG, TAG + ": " + "OnPause RenderView " + this);
    ...
    public void onDrawFrame(GL10 gl1) {
        GL11 gl = (GL11) gl1;
        if (!mFirstDraw) {
            Log.i(Gallery.TAG, TAG + ": " + "First Draw");
        }
        mFirstDraw = true;
    ...
    public void onSurfaceCreated(GL10 gl1, EGLConfig config) {
        ...
        if (mGL == null) {
            ...
            Log.i(Gallery.TAG, TAG + ": " + "GLObject has changed from " + mGL + " to " + gl);
            mGL = gl;
        }
        setRenderMode(GLSurfaceView.RENDERMODE_WHEN_DIRTY);
    ...
    public void handleLowMemory() {
        Log.i(Gallery.TAG, TAG + ": " + "Handling low memory condition");
        if (mRootLayer != null) {
