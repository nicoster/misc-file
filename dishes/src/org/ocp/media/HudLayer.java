...
import org.ocp.media.MenuBar.Menu;
import org.ocp.media.PopupMenu.Option;
...
//
// Openpeak - MAP: Using this option results in the following error:
//
// android.content.ActivityNotFoundException: No Activity found to handle 
//   Intent { act=android.intent.action.VIEW dat=geo:43.21666717529297,-123.02000427246094 }
//
//                MediaItem item = MediaBucketList.getFirstItemSelection(buckets);
...
//                }
    ...
    private void computeSizeForPathbar() {
        float pathBarWidth = mWidth
                - ((mGridLayer.getState() == GridLayer.STATE_FULL_SCREEN) ? 48 * App.PIXEL_DENSITY : 120 * App.PIXEL_DENSITY);
        mPathBar.setSize(pathBarWidth, FloatMath.ceil(60 * App.PIXEL_DENSITY));
    ...
    private void updateViews() {
        ...
        int height = (int) (141 * App.PIXEL_DENSITY);
        switch (state) {
...
//                }
        ...
        topRightButton.setSize((int) (150 * App.PIXEL_DENSITY), height);
