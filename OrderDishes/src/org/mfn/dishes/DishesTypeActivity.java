...
public class DishesTypeActivity extends Activity {
	...
	public static final String TAG = "DishesTypeActivity";
	...
	private void listAllDishTyps() {
		DishesDataAdapter adapter = DishesDataAdapter.getInstance();

		DishTypeObj[] objs = adapter.listDishTypes();

		for (DishTypeObj obj : objs) {
			Log.i(TAG, "TypeId=" + obj.id + "\tName=" + obj.name + "\tIndex=" + obj.index);
		}
	}
