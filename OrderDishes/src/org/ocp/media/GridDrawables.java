...
public final class GridDrawables {
    ...
    public static final int[] TEXTURE_SPINNER = new int[24];
    ...
    public Texture[] mTextureSpinner = new Texture[24];
    ...
    static {
        ...
        textureSpinner[0] = Res.drawable.ic_spinner00;
        textureSpinner[1] = Res.drawable.ic_spinner01;
        textureSpinner[2] = Res.drawable.ic_spinner02;
        textureSpinner[3] = Res.drawable.ic_spinner03;
        textureSpinner[4] = Res.drawable.ic_spinner04;
        textureSpinner[5] = Res.drawable.ic_spinner05;
        textureSpinner[6] = Res.drawable.ic_spinner06;
        textureSpinner[7] = Res.drawable.ic_spinner07;
        textureSpinner[8] = Res.drawable.ic_spinner08;
        textureSpinner[9] = Res.drawable.ic_spinner09;
        textureSpinner[10] = Res.drawable.ic_spinner10;
        textureSpinner[11] = Res.drawable.ic_spinner11;
        textureSpinner[12] = Res.drawable.ic_spinner12;
        textureSpinner[13] = Res.drawable.ic_spinner13;
        textureSpinner[14] = Res.drawable.ic_spinner14;
        textureSpinner[15] = Res.drawable.ic_spinner15;
        textureSpinner[16] = Res.drawable.ic_spinner16;
        textureSpinner[17] = Res.drawable.ic_spinner17;
        textureSpinner[18] = Res.drawable.ic_spinner18;
        textureSpinner[19] = Res.drawable.ic_spinner19;
        textureSpinner[20] = Res.drawable.ic_spinner20;
        textureSpinner[21] = Res.drawable.ic_spinner21;
        textureSpinner[22] = Res.drawable.ic_spinner22;
        textureSpinner[23] = Res.drawable.ic_spinner23;
    }
    ...
    public void onSurfaceCreated(RenderView view, GL11 gl) {
        ...
        mTextureSpinner[0] = view.getResource(Res.drawable.ic_spinner00);
        mTextureSpinner[1] = view.getResource(Res.drawable.ic_spinner01);
        mTextureSpinner[2] = view.getResource(Res.drawable.ic_spinner02);
        mTextureSpinner[3] = view.getResource(Res.drawable.ic_spinner03);
        mTextureSpinner[4] = view.getResource(Res.drawable.ic_spinner04);
        mTextureSpinner[5] = view.getResource(Res.drawable.ic_spinner05);
        mTextureSpinner[6] = view.getResource(Res.drawable.ic_spinner06);
        mTextureSpinner[7] = view.getResource(Res.drawable.ic_spinner07);
        mTextureSpinner[8] = view.getResource(Res.drawable.ic_spinner08);
        mTextureSpinner[9] = view.getResource(Res.drawable.ic_spinner09);
        mTextureSpinner[10] = view.getResource(Res.drawable.ic_spinner10);
        mTextureSpinner[11] = view.getResource(Res.drawable.ic_spinner11);
        mTextureSpinner[12] = view.getResource(Res.drawable.ic_spinner12);
        mTextureSpinner[13] = view.getResource(Res.drawable.ic_spinner13);
        mTextureSpinner[14] = view.getResource(Res.drawable.ic_spinner14);
        mTextureSpinner[15] = view.getResource(Res.drawable.ic_spinner15);
        mTextureSpinner[16] = view.getResource(Res.drawable.ic_spinner16);
        mTextureSpinner[17] = view.getResource(Res.drawable.ic_spinner17);
        mTextureSpinner[18] = view.getResource(Res.drawable.ic_spinner18);
        mTextureSpinner[19] = view.getResource(Res.drawable.ic_spinner19);
        mTextureSpinner[20] = view.getResource(Res.drawable.ic_spinner20);
        mTextureSpinner[21] = view.getResource(Res.drawable.ic_spinner21);
        mTextureSpinner[22] = view.getResource(Res.drawable.ic_spinner22);
        mTextureSpinner[23] = view.getResource(Res.drawable.ic_spinner23);
    }
