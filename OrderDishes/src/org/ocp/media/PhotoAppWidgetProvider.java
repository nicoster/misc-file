...
public class PhotoAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            if (LOGD) {
                Log.d(Gallery.TAG, TAG + ": " + "sending out views=" + views + " for id=" + appWidgetId);
            }
    ...
    static class PhotoDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + TABLE_PHOTOS + " (" + FIELD_APPWIDGET_ID + " INTEGER PRIMARY KEY,"
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (version != DATABASE_VERSION) {
                Log.w(Gallery.TAG, TAG + ": " + "Destroying all old data.");
        ...
        public boolean setPhoto(int appWidgetId, Bitmap bitmap) {
            ...
            try {
                ...
                Log.e(Gallery.TAG, TAG + ": " + "Could not open database", e);
            } catch (IOException e) {
                Log.e(Gallery.TAG, TAG + ": " + "Could not serialize photo", e);
            }
            if (LOGD) {
                Log.d(Gallery.TAG, TAG + ": " + "setPhoto success=" + success);
            }
            return success;
        }
        ...
        public Bitmap getPhoto(int appWidgetId) {
            ...
            try {
                ...
                if (c != null && LOGD) {
                    Log.d(Gallery.TAG, TAG + ": " + "getPhoto query count=" + c.getCount());
                }
                ...
                Log.e(Gallery.TAG, TAG + ": " + "Could not load photo from database", e);
            } finally {
                if (c != null) {
                    c.close();
                }
        ...
        public void deletePhoto(int appWidgetId) {
            try {
                ...
                Log.e(Gallery.TAG, TAG + ": " + "Could not delete photo from database", e);
            }
        }
    }
