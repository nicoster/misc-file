...
/**
 * import com.ocp.media.Gallery; This class provides several utilities to
 * cancel bitmap decoding.
 * 
...
public class BitmapManager {
    ...
    public Bitmap decodeFileDescriptor(FileDescriptor fd, BitmapFactory.Options options) {
        ...
        if (!canThreadDecoding(thread)) {
            Log.d(Gallery.TAG, TAG + ": " + "Thread " + thread + " is not allowed to decode.");
            return null;
        }
