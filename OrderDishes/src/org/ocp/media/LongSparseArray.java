...
public final class LongSparseArray<E> {
    ...
    private static final String TAG = "LongSparceArray";
    ...
    private void gc() {
        // Log.e(Gallery.TAG, TAG + ": " + "gc start with " + mSize);
        ...
        // Log.e(Gallery.TAG, TAG + ": " + "gc end with " + mSize);
    }
    ...
    public void put(long key, E value) {
        ...
        if (i >= 0) {
            ...
            if (mSize >= mKeys.length) {
                ...
                // Log.e(Gallery.TAG, TAG + ": " + "grow " + mKeys.length +
                // " to " + n);
            ...
            if (mSize - i != 0) {
                // Log.e(Gallery.TAG, TAG + ": " + "move " + (mSize - i));
    ...
    public void append(long key, E value) {
        ...
        if (pos >= mKeys.length) {
            ...
            // Log.e(Gallery.TAG, TAG + ": " + "grow " + mKeys.length + " to " +
            // n);
            System.arraycopy(mKeys, 0, nkeys, 0, mKeys.length);
            System.arraycopy(mValues, 0, nvalues, 0, mValues.length);
        ...
        for (int i = 1; i < mSize; i++) {
            if (mKeys[i] <= mKeys[i - 1]) {
                for (int j = 0; j < mSize; j++) {
                    Log.e(Gallery.TAG, TAG + ": " + j + ": " + mKeys[j] + " -> " + mValues[j]);
                }
    ...
    public static final class ArrayUtils {
        ...
        public static <T> T[] emptyArray(Class<T> kind) {
            ...
            if (cache == null || cache.getClass().getComponentType() != kind) {
                ...
                // Log.e(Gallery.TAG, TAG + ": " + "new empty " + kind.getName()
                // + " at " +
                // bucket);
            }
