...
--*/
{
    ...
    fprintf(stderr, "%p %d\t", hInternet, dwInternetStatus);
    ...
    case INTERNET_STATUS_P3P_POLICYREF:
        fprintf(stderr, "Status: INTERNET_STATUS_P3P_POLICYREF\n");
        break;

    case INTERNET_STATUS_USER_INPUT_REQUIRED:
        fprintf(stderr, "Status: INTERNET_STATUS_USER_INPUT_REQUIRED\n");
